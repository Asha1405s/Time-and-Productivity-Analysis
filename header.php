<head>
  ...
  // Change the system name to "Project Management System"
  $_SESSION['system']['name'] = "Project Management System";

  // Get the title based on the 'page' parameter from the URL
  $title = isset($GET['page']) ? ucwords(str_replace("", ' ', $_GET['page'])) : "Home";
?>
